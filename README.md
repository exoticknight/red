...
```sh
pipx run --spec red-methodology-cli red skill install --scope repo
```
...
```sh
npx -y red-methodology-cli@latest instructions install --target AGENTS.md
npx -y red-methodology-cli@latest instructions export --output RED.md
```
